...
export const Section4 = () => {
  return (
    <section
      className="container mx-auto px-0 xl:px-[294px] pb-[57px]"
      id="section4"
    >
      <div className="relative flex flex-col lg:flex-row justify-between items-center gap-7 lg:gap-0">
        <NextSection id="#section5" />
        ...
        <div className="w-full lg:w-[45%] bg-white rounded-[32px] border-2 border-black h-fit py-7 lg:py-12 xl:py-[90px] px-3 lg:px-8 xl:px-16 flex flex-col gap-7">
          {data.map((i, id) => (
